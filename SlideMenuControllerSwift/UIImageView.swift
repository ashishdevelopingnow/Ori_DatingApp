...
//
//  Created by DevelopingNow on 11/3/15.
//  Copyright © 2015 DevelopingNow. All rights reserved.
//
...
extension UIImageView {
    ...
    func setRandomDownloadImage(_ width: Int, height: Int) {
        ...
        let dict = UserDefaults.standard.value(forKey: "user_fb_data") as! NSDictionary
        var fbImgurl = (((dict.value(forKey: "picture")) as! NSDictionary).value(forKey: "data") as! NSDictionary).value(forKey: "url")!

        if fbImgurl == nil {
            fbImgurl = "http://lorempixel.com/\(width)/\(height)/"
        }
        
        let url = URL(string: fbImgurl as! String)!
